...
import { PrimaryButton, StyledCardPequeno, StyledCardGrande, CardIconContainer, CardContentContainer, ActionButton, AddButton } from "../styles";
...
interface CargoProps {
	...
	cardData: { vagas: number; autorizacoes: number; reservas: number; convocar: number };
	setCardData: (data: { vagas: number; autorizacoes: number; reservas: number; convocar: number }) => void;
		...
		<Card style={{ borderRadius: 8, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
			<Space direction="vertical" size="small" style={{ width: "100%" }}>
				...
				<Select
					...
					onChange={(v) => setCargoSelecionado(v)}
